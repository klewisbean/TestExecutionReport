...
public class ReleaseExportAutomationCTRTCM {
    ...
    public String searchtestexecutions = "plugins/servlet/ac/com.thed.zephyr.je/general-executions-enav?project.key=CTRTCM&project.id=13100#!view=list&offset=1";
    public String ZQL_SEARCH = "";
    final static Logger logger = Logger.getLogger(ReleaseExportAutomationCTRTCM.class);
    public ReleaseExportAutomationCTRTCM(String username, String password, String zqlsearch, int count){
